...
1. Clone the repository from the GitHub link you provided: https://github.com/NareshKumar3933/Registration-form.git

2. After cloning the repository, open the "database" folder. Inside this folder, you will find two files: "customerdetails.csv" and "customerdetails.sql".
...
3. Once you have imported the file into your MySQL server, navigate to the "dbConnection" folder in the cloned repository. 
...
4. Open a web browser and enter the URL in the following format: 'http://hostname/project-name/'.
